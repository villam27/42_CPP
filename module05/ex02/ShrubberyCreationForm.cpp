...
/*   Updated: 2023/05/05 15:19:25 by alboudje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm &copy) : AForm(copy.getName(), 145, 137), target(copy.getTarget())
{
...
void	ShrubberyCreationForm::execute(const Bureaucrat& executor) const
{
	...
	std::cout << "Creating shruberry file" << std::endl;
}